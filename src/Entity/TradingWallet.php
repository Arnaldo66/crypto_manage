 ...
 * @ORM\Entity(repositoryClass="App\Repository\TradingWalletRepository")
 */
class TradingWallet
{
    /**
     ...
     * Set euroWallet
     *
     * @param \App\Entity\EuroWallet $euroWallet
     *
     * @return TradingWallet
     */
    public function setEuroWallet(\App\Entity\EuroWallet $euroWallet = null)
    {
     ...
     * Add currencyWallet
     *
     * @param \App\Entity\CurrencyWallet $currencyWallet
     *
     * @return TradingWallet
     */
    public function addCurrencyWallet(\App\Entity\CurrencyWallet $currencyWallet)
    {
     ...
     * @param \App\Entity\CurrencyWallet $currencyWallet
     */
    public function removeCurrencyWallet(\App\Entity\CurrencyWallet $currencyWallet)
    {
     ...
     * Add tradingOrder
     *
     * @param \App\Entity\TradingOrder $tradingOrder
     *
     * @return TradingWallet
     */
    public function addTradingOrder(\App\Entity\TradingOrder $tradingOrder)
    {
     ...
     * @param \App\Entity\TradingOrder $tradingOrder
     */
    public function removeTradingOrder(\App\Entity\TradingOrder $tradingOrder)
    {
